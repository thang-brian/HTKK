...
$sql_lietke_dv = "SELECT * FROM anh WHERE style ='dvvanchuyen' and nation = 'Hoa Kỳ'  ORDER BY id ";
...
$sql_lietke_bg = "SELECT * FROM anh WHERE style ='bgvanchuyen' and nation = 'Hoa Kỳ'   ORDER BY id ";
    ...
    <header>
        ...
        <div class="menu" >
            <nav>
                ...
                <li>
                    <a href="#"><?php echo $lang['vncnUS'] ?></a>
                </li>
                <li>
                    <a href="#"><?php echo $lang['mhcn'] ?></a>
                </li>
                <li>
                    <a href="../America/chitiet-US/thongquan/thongquan.php"><?php echo $lang['thquan'] ?></a>
                </li>
                <li>
                    <a href="../America/chitiet-US/index.php?quanly=chuyentien"><?php echo $lang['chuyentien'] ?></a>
                </li>
                <li>
                    <a href="../America/chitiet-US/index.php?quanly=banggia"><?php echo $lang['banggia'] ?></a>
                </li>
                <li>
