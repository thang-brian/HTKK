...
$sql_lietke_dv = "SELECT * FROM anh WHERE style ='dvvanchuyen' and nation = 'Trung Quốc' and trang_thai = 1  ORDER BY id ";
...
$sql_lietke_bg = "SELECT * FROM anh WHERE style ='bgvanchuyen' and nation = 'Trung Quốc'   ORDER BY id ";
...
<head>
    ...
    <title>HTKK | Vận chuyển hàng Trung Quốc</title>
...
<body>
    <header>
        <!-- <div class="sl" >
            <p>
                Chọn ngôn ngữ: <button class="translate" id="vi"><img src="../../../img/vietnam.png" alt=""></button> 
                                <button class="translate" id="en"><img src="../../../img/anh.png" alt=""></button>
            </p>
        </div> -->
        <div class="menu" >
            <nav>
                ...
                <li>
                    <a href="#"><?php echo $lang['vncn'] ?></a>
                </li>
                <li>
                    <a href="#"><?php echo $lang['mhcn'] ?></a>
                </li>
                <li>
                    <a href="../China/chitiet-CN/thongquan/thongquan.php"><?php echo $lang['thquan'] ?></a>
                </li>
                <li>
                    <a href="../China/chitiet-CN/index.php?quanly=chuyentien"><?php echo $lang['chuyentien'] ?></a>
                </li>
                <li>
                    <a href="../China/chitiet-CN/index.php?quanly=banggia" ><?php echo $lang['banggia'] ?></a>
                </li>
                <li>
        ...
        <div class="dv" >
            ...
            <div class="dichvu-value" >
                ...
                <div class="dichvu-vc" >
                    ...
                    <p class="dichvu-vl-background" ><?php echo $row['nd_'.$_SESSION['lang']] ?></p>
                    <p class="dichvu-vl-txt">
