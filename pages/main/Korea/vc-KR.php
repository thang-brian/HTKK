...
$sql_lietke_dv = "SELECT * FROM anh WHERE style ='dvvanchuyen' and nation = 'Hàn Quốc' and trang_thai = 1  ORDER BY id ";
...
$sql_lietke_bg = "SELECT * FROM anh WHERE style ='bgvanchuyen' and nation = 'Hàn Quốc'   ORDER BY id ";
...
<body>
    <header>
        <div class="menu" >
            <nav>
                ...
                <li>
                    <a href="#"><?php echo $lang['vncnKR'] ?></a>
                </li>
                <li>
                    <a href="#"><?php echo $lang['mhcnKR'] ?></a>
                </li>
                <li>
                    <a href="../Korea/chitiet-KR/thongquan/thongquan.php"><?php echo $lang['thquan'] ?></a>
                </li>
                <li>
                    <a href="../Korea/chitiet-KR/index.php?quanly=chuyentien"><?php echo $lang['chuyentien'] ?></a>
                </li>
                <li>
                    <a href="../Korea/chitiet-KR/index.php?quanly=banggia"><?php echo $lang['banggia'] ?></a>
                </li>
                <li>
    ...
    <body>
        ...
        <div>
            <p class="introduction lang" key="qtchuyen">QUY TRÌNH CHUYỂN HÀNG</p>
            <img src="../../../img/border-dv-cn.png" style="width:100%" alt="">
