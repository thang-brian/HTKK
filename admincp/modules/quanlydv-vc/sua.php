<?php
	$sql_sua_dv = "SELECT * FROM anh WHERE style ='dvvanchuyen' and id='$_GET[id]' LIMIT 1";
...
?>
 <form method="POST" action="modules/quanlydv-vc/xuly.php?id=<?php echo $row['id'] ?>" enctype="multipart/form-data">
	   <tr>
	  	<td>Hình ảnh</td>
	  	<td>
	  		<input type="file" name="hinhanh">
	  		<img src="modules/quanlydv-vc/uploads/<?php echo $row['hinhanh'] ?>" width="150px">
	  	</td>
	  </tr>
	  <tr>
	  	<td>Quốc gia</td>
